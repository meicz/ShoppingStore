 ...
 */
public class Fragmentactivity extends FragmentEx {  
	...
	private Handler mCommodHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case FragmentEx.UPDATE_VIEW: {
				//显示购物车页面 
				ListView listView =  (ListView) getView().findViewById(R.id.listView_cxlist);  
				if(mCxAdapter == null){
		...
		Thread thread = new Thread(new Runnable(){
            ...
            public void run(){
            	...
            	try {
            		//加载数据
            		if(isAllRefresh){
            			CxListResponse res = req.doGet(CxListResponse.class.getName());
